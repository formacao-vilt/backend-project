...
<meta name="viewport"
 ...
 <body class="gradiente">
    ...
    <nav id="cabecalho">
      <a href="http://localhost:8085/sistema/contatoo.jsp"><button style="background: #DCDCDC; border-radius: 10px; padding: 15px; cursor: pointer; color: #000000; border: none; font-size: 40px;">Contato</button></a>
      <a href="#conteudo" class="links" id="link1"><button style="background: #DCDCDC; border-radius: 10px; padding: 15px; cursor: pointer; color: #000000; border: none; font-size: 40px;">Conteúdo</button></a>
      <a href="#cadastrar"class="links" id="link2"><button style="background: #DCDCDC; border-radius: 10px; padding: 15px; cursor: pointer; color: #000000; border: none; font-size: 40px;">Cadastrar</button></a>
      <a href="#lista"class="links" id="lista"><button style="background: #DCDCDC; border-radius: 10px; padding: 15px; cursor: pointer; color: #000000; border: none; font-size: 40px;">Lista de alunos</button></a>
